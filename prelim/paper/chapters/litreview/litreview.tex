...
\subsection{The Network Simplex Algorithm}\label{sec:trans-simplex}

\section{The Linear Approximation Model}\label{sec:approx}

\section{The Multicommodity Transport Problem}\label{sec:MCTP}
