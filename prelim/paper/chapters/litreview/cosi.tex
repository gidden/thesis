...
The real power of COSI, and also the source of some criticsm, lies in its
ability to model fuel residence in reactors. For each reactor type, a specific
core geometry, an input isotopic composition (taken from the process described
above), a target burnup, and an irradiation time are used as input for their
