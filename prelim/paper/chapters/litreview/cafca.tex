...
As an example of the matematics and methodology behind the structure-policy
...
From the forcasted fleet calcuation and the number of commercially operating
...
This value defines the constrouction order rate,
