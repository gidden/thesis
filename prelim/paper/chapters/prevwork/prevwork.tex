...
\subsection{Facility Building Infrastructure}

Two main additions were made to the infrastructure related to building
facilities. The primary infrastructure change is the new usage of the Prototype
design pattern \cite{vlissides_design_1995} to govern how new instances of
facilities of a given agent-type are instantiated. A mixin class
\cite{ulrich_mixin-based_2001} (Builder) was also designed to provide an
interface for building new prototypes.
