...
is met between the two codes, with a slight difference occuring in how the first
...
some time t includes the flows occuring at time t plus all flows occuring at
previous times. Accordingly, a slight discrepency, occuring at each time period,
...
discrepency related to the first time period phase shift with respect to
