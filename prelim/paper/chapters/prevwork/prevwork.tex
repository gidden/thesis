...
\begin{figure}
  \begin{center}
    ...
    {%
      \label{fig:rxtrs_low}
      \includegraphics[width=.38\linewidth]{./chapters/prevwork/graphs/rxtrs_low.png}
    }
    \hfill
    \horizfig
    []
    {
      ...
      \includegraphics[width=.38\linewidth]{./chapters/prevwork/graphs/rxtrs_high.png}
    }
  \end{center}
...
%   \centering
%   \includegraphics[width=.4\linewidth]{./chapters/prevwork/graphs/rxtrs_low.png}
%   \caption{Reactors built due to the ``low'' demand case.}
%   \label{fig:rxtrs_low}
% \end{subfigure}
% \begin{subfigure}{.5\textwidth}
%   \centering
%   \includegraphics[width=.4\linewidth]{./chapters/prevwork/graphs/rxtrs_high.png}
%   \caption{Reactors built due to the ``high'' demand case.}
%   \label{fig:rxtrs_high}
% \end{subfigure}
% \end{center}
% \caption{Reactors built in each INPRO demand case.}
