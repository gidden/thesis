...
into approriate classes. Four classes have been constructed with specific
...
Other input file formats can be supported by providing the approriate
format-specific derived QueryEngine class and adjusting the application code as
neccessary. To developer could then choose how to implement the loading and
