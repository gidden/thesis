...
%-----------------------------------------------------------------------------
  ...
  %% for prelim
  %% with small margins
  % \hspace*{-2cm}Date of preliminary oral examination: \@defensedate \\[\@thesistitlemedskip]
  % \hspace*{-2cm}The preliminary report is presented to the following members of the Examining Committee:\\
  %% with large margins
  Date of preliminary oral examination: \@defensedate \\[\@thesistitlemedskip]
  The preliminary report is presented to the following members of the Examining Committee:\\
  %%
  \@committee
  \end{titlepage}
