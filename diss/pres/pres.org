...
#+caption: An example of a bare ExchangeGraph.
#+attr_latex: :height 5cm
[[file:figs/exchange_bare_words.pdf]]

*** Translation to Exchange Layer
#+caption: An example of an ExchangeGraph with portfolios.
#+attr_latex: :height 5cm
...
*** Transportation Problem
#+caption: An example bipartite graph with attribute labels.
#+attr_latex: :height 5cm
