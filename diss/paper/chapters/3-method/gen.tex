...
\\ \hline
\multirow{3}{*}{Thermal} & 
UOX   & $[3.5, 5.5]$         & N/A & 0.5        \\ \cline{2-5} 
& 
TMOX  & $[55, 65]$         & 7 & 1      \\ \cline{2-5} 
& 
FMOX  & $[55, 65]$         & 7 & 0.1      \\ \hline
\multirow{4}{*}{FMOX}    & 
UOX & $[15, 20]$         & N/A  & 0.1     \\ \cline{2-5} 
& 
...
\nucl{233}{U}, a factor, $f_{\text{commod}}$, of 100 is added for for Plutonium
and Thorium-based commodities, defined in Equation \ref{eqn:fissfactor}.

\begin{equation}\label{eqn:fissfactor}
    f_{\text{commod}} =
    \begin{cases}
    1,& \text{if UOX}\\
    100,              & \text{otherwise}
