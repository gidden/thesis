...
Polynomial-time ($\mathcal{P}$), Non-deterministic Polynomial-time
($\mathcal{NP}$), Non-deterministic Polynomial-time Complete ($\mathcal{NP}$-C),
and Non-deterministic Polynomial-time Hard ($\mathcal{NP}$-hard). A classic
