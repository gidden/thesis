...
The resource layer utilizes \textit{templated} objects in order to reduce the
...
Resources, Bid/Request, Portfolios, Constraint, 
...
OSI, Flow Bounds, Constraint Matrix, RHS vector, Objective Coefficients,
