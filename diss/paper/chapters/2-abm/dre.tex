...
Given the original number of nodes in $I$ and the number of bid portfolios,
$N_{p, b}$, the total number of bid nodes including false nodes is

\begin{equation}
  \left|{I_t}\right| = \left|{I}\right| + N_{p, b} + 1
\end{equation}

Similarly, the total number of request nodes is

\begin{equation}
  \left|{J_t}\right| = \left|{J}\right| + N_{p, r} + 1
\end{equation}
